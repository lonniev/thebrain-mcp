...
[![Horizon](https://img.shields.io/badge/Deployed_on-Horizon-purple.svg)](https://www.fastmcp.com/)
...
├── fastmcp.json             # Horizon deploy entrypoint (src/thebrain_mcp/server.py)
