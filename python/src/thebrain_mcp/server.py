...
async def get_thought_by_name(
    ...
    """Exact name lookup — returns the first thought matching the name exactly.
...
async def get_thought_graph(
    ...
    """Get a thought's full connection graph.
...
async def get_thought_graph_paginated(
    ...
    """Cursor-based paginated traversal of a thought's connections.
...
async def get_types(brain_id: str | None = None, npub: str = "") -> dict[str, Any]:
    """List all thought types defined in the brain.
